...
<?php
    $select_user = "select * from user where username='{$_SESSION["u_username"]}'";
            ...
            <form action="" method="post">
                <div class="row shadow rounded my-4 mx-1 py-4 bg-white">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" name="adminid_txt" id="" value="<?= $data['user_id'] ?>" class="form-control" required="" readonly="true">
                        </div>
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email_txt" id="" value="<?= $data['email_id'] ?>" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label for="">Mobile</label>
                            <input type="text" name="mobile_txt" id="" value="<?= $data['mobile_no'] ?>" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label for="">Address</label>
                            <textarea name="address_txt" id="" cols="30" rows="3" class="form-control" required=""><?= $data['address'] ?></textarea>
                            <!-- <input type="text" name="address_txt" id="" value="<?= $data['address'] ?>" class="form-control" required=""> -->
                        </div>
                        <div class="form-group">
