...
?>
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="row mt-4">
                <div class="col-md-3"> 
                    <div class="d-flex shadow p-3 rounded bg-info bg-gradient text-white ">
                        <div class="w-25">
                        ...
                        <div>
                            <h4>
                                <?php
                                    //total users
                                    $query=mysqli_query($conn,"select user_id from user where status='1'");
                                    $count_total_users=mysqli_num_rows($query);
                ...
                <div class="col-md-3"> 
                    <div class="d-flex shadow p-3 rounded bg-warning bg-gradient text-white ">
                        <div class="w-25">
                        ...
                        <div>
                            <h4>
                                <?php
                                    //total customers
                                    $query=mysqli_query($conn,"select customer_id from customer where status='1'");
                                    $count_customer=mysqli_num_rows($query);
                                    echo $count_customer;
                                ?>
                            </h4>
