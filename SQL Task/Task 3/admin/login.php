...
<body>
    <div class="container">
        <div class="row pt-5 mt-5">
            <div class="col-md-4 m-auto border shadow rounded my-5 py-4 px-4">
                    <h4 class="text-center montserrat-fnt">Admin Login</h4>
...
if(isset($_POST['login_btn'])){
    ...
    $pass = md5($pass);
    $select_user = "select * from admin where username='$usernm' and password='$pass'";
...
<?php
    ...
    // $verify = hash('sha512', $_password); //get user password
