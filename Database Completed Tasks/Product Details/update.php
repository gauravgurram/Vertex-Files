        ...
        <div class="main">
            ...
            <table>
                ...
                <tr>
                    <td>mfgdate</td>
                    <td>
                        <input type="date" name="mfgdate" value="<?php echo $rw[3];?>">
                    </td>
                </tr>
                <tr>
                    <td>expdate</td>
                    <td>
                        <input type="date" name="expdate" value="<?php echo $rw[4];?>">
                    </td>
                </tr>
            </table><br>
...
if(isset($_POST['btn1']))
{
    ...
    $sql1="update productdetails set name='$name',price='$price',mfgdate='$mfgdate',expdate='$expdate' where id='$id'";
